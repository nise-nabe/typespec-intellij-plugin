...
- Bump pinned IDEA SDK to IntelliJ IDEA 2026.2.3 (`262.10968.63`)
...
- Added embedded JSON Schema validation and completion for `tspconfig.yaml` project configuration keys
